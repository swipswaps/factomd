...
func NewRemoveFederatedServer(identityChainID interfaces.*HashS, dbheight uint32) (e *RemoveFederatedServer) {
...
func (e *RemoveFederatedServer) Hash() (rval interfaces.*HashS) {
