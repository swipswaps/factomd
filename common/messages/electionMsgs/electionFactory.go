...
func (e *ElectionsFactory) NewAddLeaderInternal(name string, dbheight uint32, serverID interfaces.*HashS) interfaces.IMsg {
...
func (e *ElectionsFactory) NewAddAuditInternal(name string, dbheight uint32, serverID interfaces.*HashS) interfaces.IMsg {
...
func (e *ElectionsFactory) NewRemoveLeaderInternal(name string, dbheight uint32, serverID interfaces.*HashS) interfaces.IMsg {
...
func (e *ElectionsFactory) NewRemoveAuditInternal(name string, dbheight uint32, serverID interfaces.*HashS) interfaces.IMsg {
...
func (e *ElectionsFactory) NewEomSigInternal(name string, dbheight uint32, minute uint32, vmIndex int, height uint32, serverID interfaces.*HashS) interfaces.IMsg {
...
func (e *ElectionsFactory) NewDBSigSigInternal(name string, dbheight uint32, minute uint32, vmIndex int, height uint32, serverID interfaces.*HashS) interfaces.IMsg {
	msg := new(EomSigInternal)
	msg.SigType = false
	msg.NName = name
	msg.DBHeight = dbheight
